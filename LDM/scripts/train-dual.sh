...
partition=0 # choose between 0 and 1 for dual model training, or full for normal training
...
MODEL_NAME="runwayml/stable-diffusion-v1-5"
data_dir="../datasets/pokemon"
partition=1 # choose between 0 and 1 for dual model training, or full for normal training
output_dir="./experiments/pokemon-rand_caption-partition-$partition"
