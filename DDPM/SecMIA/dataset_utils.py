...
def load_member_data(dataset_root, dataset_name, batch_size=128, member_split_root='./mia_evals/member_splits', shuffle=False, drop_last=True, randaugment=False):
    ...
    member_loader = torch.utils.data.DataLoader(member_set, batch_size=batch_size, shuffle=shuffle, drop_last=drop_last)
    nonmember_loader = torch.utils.data.DataLoader(nonmember_set, batch_size=batch_size, shuffle=shuffle, drop_last=drop_last)
